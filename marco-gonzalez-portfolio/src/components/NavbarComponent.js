      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto">
            <Nav.Link href="#ExperienceID"><h6 className="linkText">{item1}</h6></Nav.Link>
            <Nav.Link href="#ProjectsID"><h6 className="linkText">{item2}</h6></Nav.Link>
            <Nav.Link href="#TechnicalSkillsID"><h6 className="linkText">{item3}</h6></Nav.Link>
